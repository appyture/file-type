...
var require_lib = __commonJS({
  "node_modules/.pnpm/readable-web-to-node-stream@3.0.2/node_modules/readable-web-to-node-stream/lib/index.js"(exports) {
    "use strict";
    init_shim();
...
async function fileTypeStream(readableStream, { sampleSize = minimumBytes } = {}) {
  const { default: stream } = await Promise.resolve().then(() => __toESM(require_stream_browserify(), 1));
